...
class string_iterator<CharT, IsConst> {
public:
    // Iterator traits
...
public:
	...
	constexpr string_iterator(const string_iterator&) noexcept = default;

	constexpr string_iterator& operator=(const string_iterator&) noexcept = default;
